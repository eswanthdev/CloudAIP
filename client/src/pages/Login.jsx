  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-16">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 left-1/3 w-72 h-72 bg-cyan/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 right-1/3 w-72 h-72 bg-purple/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        <div className="glass rounded-2xl p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Sign in to your CloudAIP account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-3 rounded-xl bg-gradient-to-r from-cyan to-cyan-dark text-primary font-semibold hover:shadow-lg hover:shadow-cyan/25 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
          ...
          <p className="text-center text-sm text-slate-400 mt-6">
            ...
            <Link to="/register" className="text-cyan hover:underline font-medium">
              Create one
            </Link>
          </p>
        </div>
